...
import { Register } from 'src/app/components/register/register.model';
...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void{
    this.registerService.readRegister().subscribe(db =>{
      this.register = db //db = db.json
      
      this.register.map(e => this.container.push([e.month, e.numberOfCases]));
    })
